...
(function (deps, factory) {
        ...
        if (obj) {
            if (del === true) {
                ...
                if (_.isArray(obj[member])) {
                    ...
                    _.forEach(obj[member], function (v, k) {
    ...
    (function (Services) {
        var ErrorLookup = (function () {
            function ErrorLookup($interpolate, $q, $http, $timeout) {
                var _this = this;
            ...
            ErrorLookup.prototype.translate = function (message) {
                ...
                if (_.isString(message)) {
                    ...
                    var out = {};
                    _.forEach(message, function (str, key) {
            ...
            ErrorLookup.prototype.error = function (group, name, predefine, bypass) {
                ...
                var modelByDefinition = function (model) {
                    return _.find(repo.models, function (m) { return m.controller === model; }) || model;
                };
                    ...
                    if (name) {
                        if (typeof this.repository[group].models[name] !== 'undefined') {
                            ...
                            if (pick.length === 0) {
                                ...
                                empty(model, 'forced', function (value, k) { return _.contains(pick, k); });
                            }
            ...
            ErrorLookup.prototype.label = function (group, item, label) {
                ...
                if (_.isPlainObject(item)) {
                    _.forEach(item, function (label, key) {
            ...
            ErrorLookup.instance = function ($interpolate, $q, $http, $timeout) {
    ...
    (function (Providers) {
        var ErrorLookupProvider = (function () {
            function ErrorLookupProvider() {
                this.$get = [].concat(Services.ErrorLookup.$inject, Services.ErrorLookup.instance);
                /**
            ...
            ErrorLookupProvider.messageQueue = {
        ...
        Providers.ErrorLookup = new ErrorLookupProvider;
        ...
        var ErrorMessages = (function () {
            ...
            ErrorMessages.filter = function (item, options) {
                ...
                if (item && item.length) {
                    ...
                    }).map(function (i) { return i.message; }).valueOf();
                }
